...
- **Reflink (`Copy as reflink`) requires a kernel-mounted ghostfs.** The
  ...
  a clear error ("Reflink not available — the file is not on a ghostfs/CoW
  volume.") instead of silently falling back to a full copy.
